...
const User = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:3001/user/getMember?limit=${pageSize}&page=${currentPage - 1}&keysearch=${searchTerm}`, {
                method: 'GET',
                headers: {
    ...
    return (
        <div className="user-container">
            ...
            {showProfile && <ModalEditUser user={selectedUser} handleShowModalEdit={(handleShowModalEdit)} deleteUser={(deleteUser)} />}
        </div>
    );
}
